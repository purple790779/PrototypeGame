...
## v1.1.1 - 2026-01-20
### Added
- 스테이지 클리어 보상(파편/코어)을 난이도/스테이지 비례로 지급
### Changed
- 레벨 디자인 튜닝 상수 분리 및 NORMAL/HARD 스폰/상한/스케일 조정
- Siege 탄속/데미지 하향, 발사 간격 상향 및 적 탄 상한 정리 강화
...
## v1.0.4 - 2026-01-19
### Fixed
- 화면 밖 적을 타겟으로 잡아 무기가 화면 밖으로 향하던 문제 수정(타겟 필터)
- Droplet 무기 화면 밖 이동/추적 제한
